...
for label in range(3):
    PATH_TO_TEST_IMAGES_DIR = '../../data/bag_and_sim/{}'.format(label)
    ...
    for image_path in tqdm(TEST_IMAGE_PATHS):
      ...
      traffic_light_boxes = boxes[classes == 10]
      label_info = LabelInfo(path=image_path, label=0, boxes=traffic_light_boxes.tolist())
      label_data.append(label_info._asdict())  

open('../../data/label_data.json', 'w').write(json.dumps(label_data))
